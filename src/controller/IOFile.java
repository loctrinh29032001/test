...
public class IOFile {
    ...
    public void ghiSV(ArrayList <SinhVIen> list){
        try (PrintWriter pw = new PrintWriter(new File("NhanSu.DAT"))){
            for(SinhVIen s: list){
                pw.println(s.getID());
                pw.println(s.getTen());
    ...
    public ArrayList docSV(){
        ...
        try(Scanner sc = new Scanner(new File("NhanSu.DAT"))) {
            while(sc.hasNext()){
    ...
    public ArrayList docBT(){
        ...
        try(Scanner sc = new Scanner(new File("CongViec.DAT"))) {
            while(sc.hasNext()){
    ...
    public void ghiBT(ArrayList <BaiTapNhom> list){
        try (PrintWriter pw = new PrintWriter(new File("CongViec.DAT"))){
